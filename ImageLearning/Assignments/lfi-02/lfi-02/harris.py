...
ksize = 9
I_x = cv2.Sobel(gray, cv2.CV_32FC1, dx = 1, dy = 0, ksize = ksize)
I_y = cv2.Sobel(gray, cv2.CV_32FC1, dx = 0, dy = 1, ksize = ksize)
#I_y, I_x = np.gradient(gray)
...
k = 0.04
threshold = 0.01
harris_thres = np.zeros(gray.shape)
